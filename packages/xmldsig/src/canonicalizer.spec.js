...
(0, vitest_1.describe)('Canonicalization', () => {
    ...
    function canon(exclusive, xml, xpath, result, comment = false, inclusive) {
        const doc = (0, xml_core_1.Parse)(xml);
        ...
        vitest_1.assert.equal(res, result, msg);
    }
    (0, vitest_1.describe)('Custom', () => {
        (0, vitest_1.it)('#1 Canonicalization works on xml with no namespaces', () => {
            const xml = '<root><child>123</child></root>';
            const xpath = '//*';
            C14N(xml, xpath, '<root><child>123</child></root>');
            ExcC14N(xml, xpath, '<root><child>123</child></root>');
        });
        (0, vitest_1.it)('#2 Canonicalization works on inner xpath', () => {
            const xml = '<root><child>123</child></root>';
            const xpath = '//*[local-name(.)="child"]';
            C14N(xml, xpath, '<child>123</child>');
            ExcC14N(xml, xpath, '<child>123</child>');
        });
        (0, vitest_1.it)('#3 Canonicalization works on xml with prefixed namespaces defined in output nodes', () => {
        ...
        (0, vitest_1.it)('#4 element used prefixed ns which is also the default', () => {
        ...
        (0, vitest_1.it)('#5 Canonicalization works on xml with prefixed namespaces defined in output nodes. ns definition is not duplicated on each usage', () => {
        ...
        (0, vitest_1.it)('#6 Canonicalization works on xml with prefixed namespaces defined in output nodes but before used', () => {
        ...
        (0, vitest_1.it)('#7 Canonicalization works on xml with prefixed namespaces defined outside output nodes', () => {
        ...
        (0, vitest_1.it)('#8 Canonicalization works on xml with prefixed namespace defined in inclusive list', () => {
        ...
        (0, vitest_1.it)('#9 Canonicalization works on xml with multiple prefixed namespaces defined in inclusive list', () => {
        ...
        (0, vitest_1.it)('#10 Canonicalization works on xml with prefixed namespace defined in inclusive list defined outside output nodes', () => {
        ...
        (0, vitest_1.it)('#11 Canonicalization works on xml with prefixed namespace defined in inclusive list used on attribute', () => {
        ...
        (0, vitest_1.it)('#12 Canonicalization works on xml with default namespace inside output nodes', () => {
        ...
        (0, vitest_1.it)('#13 Canonicalization works on xml with multiple different default namespaces', () => {
        ...
        (0, vitest_1.it)('#14 Canonicalization works on xml with multiple similar default namespaces', () => {
        ...
        (0, vitest_1.it)('#15 Canonicalization works on xml with default namespace outside output nodes', () => {
        ...
        (0, vitest_1.it)('#16 Canonicalization works when prefixed namespace is defined in output nodes not in the parent chain of who needs it', () => {
        ...
        (0, vitest_1.it)('#17 Canonicalization works on xml with unordered attributes', () => {
        ...
        (0, vitest_1.it)('#18 Canonicalization sorts upper case attributes before lower case', () => {
            const xml = '<x id="" Id=""></x>';
            const xpath = '//*[local-name(.)="x"]';
            C14N(xml, xpath, '<x Id="" id=""></x>');
            ExcC14N(xml, xpath, '<x Id="" id=""></x>');
        });
        (0, vitest_1.it)('#19 Canonicalization with comments retains comments', () => {
        ...
        (0, vitest_1.it)('#20 Canonicalization works on xml with attributes with different namespace than element', () => {
        ...
        (0, vitest_1.it)('#21 Canonicalization works on xml with attribute and element values with special characters', () => {
        ...
        (0, vitest_1.it)('#22 Canonicalization preserves white space in values', () => {
            const xml = '<root><child><inner>12\n3\t</inner></child></root>';
            const xpath = '//*[local-name(.)="child"]';
            C14N(xml, xpath, '<child><inner>12\n3\t</inner></child>');
            ExcC14N(xml, xpath, '<child><inner>12\n3\t</inner></child>');
        });
        (0, vitest_1.it)('#23 Canonicalization preserves white space bewteen elements', () => {
            const xml = '<root><child><inner>123</inner>\n</child></root>';
            const xpath = '//*[local-name(.)="child"]';
            C14N(xml, xpath, '<child><inner>123</inner>\n</child>');
            ExcC14N(xml, xpath, '<child><inner>123</inner>\n</child>');
        });
        (0, vitest_1.it)('#24 Canonicalization turns empty element to start-end tag pairs', () => {
            const xml = '<root><child><inner /></child></root>';
            const xpath = '//*[local-name(.)="child"]';
            C14N(xml, xpath, '<child><inner></inner></child>');
            ExcC14N(xml, xpath, '<child><inner></inner></child>');
        });
        (0, vitest_1.it)('#25 Canonicalization preserves empty start-end tag pairs', () => {
            const xml = '<root><child><inner></inner></child></root>';
            const xpath = '//*[local-name(.)="child"]';
            C14N(xml, xpath, '<child><inner></inner></child>');
            ExcC14N(xml, xpath, '<child><inner></inner></child>');
        });
        (0, vitest_1.it)('#26 Canonicalization self-closed tag', () => {
            const xml = '<root><child><inner/></child></root>';
            const xpath = '//*[local-name(.)="child"]';
            C14N(xml, xpath, '<child><inner></inner></child>');
            ExcC14N(xml, xpath, '<child><inner></inner></child>');
        });
        (0, vitest_1.it)('#27 Canonicalization with empty default namespace outside output nodes', () => {
        ...
        (0, vitest_1.it)('#28 Canonicalization removal of whitespace between PITarget and its data', () => {
            if (isNode()) {
                return;
            }
        ...
        (0, vitest_1.it)('#29 Canonicalization with empty default namespace inside output nodes', () => {
            if (isNode()) {
                return;
            }
        });
        (0, vitest_1.it)('#30 The XML declaration and document type declaration (DTD) are removed', () => {
            const xml = '<?xml version="1.0" encoding="utf-8"?><root><child><inner>123</inner></child></root>';
            const xpath = '//*[local-name(.)="child"]';
            C14N(xml, xpath, '<child><inner>123</inner></child>');
            ExcC14N(xml, xpath, '<child><inner>123</inner></child>');
        });
        (0, vitest_1.it)('#31 Attribute value delimiters are set to quotation marks (double quotes)', () => {
        ...
        (0, vitest_1.it)('#32 CDATA sections are replaced with their character content', () => {
        ...
        (0, vitest_1.it)('#33 SignedInfo canonization', () => {
        ...
        (0, vitest_1.it)('#34 Exclusive canonicalization works on complex xml', () => {
        ...
        (0, vitest_1.it)('#35 Lexicographic comparison, which orders strings from least to greatest alphabetically, is based on the UCS codepoint values, which is equivalent to lexicographic ordering based on UTF- 8.', () => {
        ...
        (0, vitest_1.it)('#36 saml attributed order', () => {
        ...
        (0, vitest_1.it)('#37 Canonicalization sorts upper case namespaces before lower case', () => {
    ...
    (0, vitest_1.describe)('Test cases for Canonical XML 2.0', () => {
        (0, vitest_1.it)('2.1 PIs, Comments, and Outside of Document Element', () => {
